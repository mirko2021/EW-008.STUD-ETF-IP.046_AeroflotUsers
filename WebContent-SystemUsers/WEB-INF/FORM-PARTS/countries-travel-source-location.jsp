...
<form id='flag_io_travel_src' name='flag_io_travel_src' action='#flag_io_travel_src'>
	<select name='flag_travel_src_io_country'>
	...
	<br>
	<c:if test='${travelBean.sourceCountry ne ""}'>
		<br>
		<c:set var='cc' value='${travelBean.sourceCountry}'></c:set>
		<table>
			<tr>
	...
	<br>
	<input type='submit' name='flag_io_travel_src_set' value='Постављање'/>
	<input type='submit' name='flag_io_travel_src_reset' value='ресетовање'/>
	<br><br>
</form>